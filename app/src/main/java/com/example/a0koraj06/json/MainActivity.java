package com.example.a0koraj06.json;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    // First paramenter to Asynctask is input data type for doInBackground
    // Second parameter Represents progress datatype
    // third parameter represents return type of the doInBackground method
    // need permision
    class GetSongsAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            //display the string in the resulttext view
        }
    }
}
